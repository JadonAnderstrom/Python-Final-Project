...
student_data = [
    {"id": 100029, "first_name": "Donal", "last_name": "Salvatore", "username": "d.salvatore", "birthdate": "3/28/2004",
     "age": 19, "city": "Elk River"},
    {"id": 100069, "first_name": "Jo-anne", "last_name": "Misson", "username": "j.misson", "birthdate": "10/27/2004",
     "age": 18, "city": "Stillwater"},
    {"id": 100076, "first_name": "Rafe", "last_name": "Ilewicz", "username": "r.ilewicz", "birthdate": "4/20/2004",
     "age": 19, "city": "Aitkin"},
    {"id": 100127, "first_name": "Bobbie", "last_name": "Thewlis", "username": "b.thewlis", "birthdate": "6/1/2002",
     "age": 21, "city": "Becker"},
    {"id": 100312, "first_name": "Larine", "last_name": "Gooden", "username": "l.gooden", "birthdate": "3/1/2002",
     "age": 21, "city": "Brooklyn Park"}
]
...
for student in student_data:
    cursor.execute(f"SELECT id FROM {table_name} WHERE id = ?", (student["id"],))
